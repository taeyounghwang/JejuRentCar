...
<div class="contentContainer">
	...
	<div id="qnaList" class="table-responsive">
		<table class="table table-bordered">
			<tr>
				<th data-value="inq_number" class="order">글 번호<c:choose>
						<c:when
							test="${data.order_by=='inq_number' and data.order_sc=='DESC' }">▼</c:when>
						<c:when
							test="${data.order_by=='inq_number' and data.order_sc=='ASC' }">▲</c:when>
