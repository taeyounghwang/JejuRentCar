package com.jeju.client.common.util;

import sun.misc.BASE64Decoder;
import sun.misc.BASE64Encoder;


/*KISA에서 제공하는 SHA256.java를 사용하면 비밀번호가 64개의 문자로 암호화 되고, 
다시 이것을 이용해 Damien Miller가 만든 BCrypt.java를 사용하면 60개의 문자로 재 암호화된다. 
따라서 데이터베이스의 비밀번호 컬럼의 길이를 60개가 문자로 저장할 수 있게 변경한다. */
